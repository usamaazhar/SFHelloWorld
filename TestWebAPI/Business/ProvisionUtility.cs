...
namespace TestWebAPI.Business
{
    public class ProvisionUtility : IProvisionUtility
    {
        ...
        public IStatefulBackend GetBackendReference(string backendName)
        {
            IStatefulBackend backendClient = 
                ServiceProxy.Create<IStatefulBackend>(new Uri($"{m_appName}/{backendName}"));
